...
// see import wala part at 02:31:49 
  ...
  return info ? (
    ...
    >
      ...
      <nav className="h-[10vh] w-full text-zinc-100 flex items-center gap-10 text-xl">
        ...
        <a target="_blank" href={`https://www.wikidata.org/wiki/${info.externalid.wikidata.id}`}>
          <i class="ri-earth-fill"></i>
        </a>
        
        <a
          target="_blank" 
          href={`https://www.imdb.com/title/${info.externalid.imdb_id}`}>imdb</a>
      </nav>
      ...
      {info.detail.seasons.info.detail.seasons.map((s,i) =>      {/*Check this line beacauseat this time video just got end so cant see proprly */}
      ...
      )}   {/* dekhna yahan ek curly braces kam hai ek tho*/}
